...
PrepareRenameResult = Union['Range', 'PrepareRenameResult_Type1', 'PrepareRenameResult_Type2']
...
class TextDocumentContentChangeEvent_Type1:
    ...
    range_length: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.uinteger_validator), default=None)
...
TextDocumentContentChangeEvent = Union['TextDocumentContentChangeEvent_Type1', 'TextDocumentContentChangeEvent_Type2']
...
class TextDocumentFilter_Type1:
    ...
    scheme: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    """A Uri {@link Uri.scheme scheme}, like `file` or `untitled`."""

    pattern: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class TextDocumentFilter_Type2:
    ...
    language: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    """A language id, like `typescript`."""
...
TextDocumentFilter = Union['TextDocumentFilter_Type1', 'TextDocumentFilter_Type2', 'TextDocumentFilter_Type3']
...
class NotebookDocumentFilter_Type2:
    ...
    notebook_type: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    """The type of the enclosing notebook."""
...
NotebookDocumentFilter = Union['NotebookDocumentFilter_Type1', 'NotebookDocumentFilter_Type2', 'NotebookDocumentFilter_Type3']
...
class TextDocumentRegistrationOptions:
    ...
    document_selector: Optional[Union[DocumentSelector, None]] = attrs.field(default=None)
...
class WorkDoneProgressOptions:
    ...
    work_done_progress: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class StaticRegistrationOptions:
    ...
    id: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class FoldingRange:
    ...
    start_character: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.uinteger_validator), default=None)
    """The zero-based character offset from where the folded range starts. If not defined, defaults to the length of the start line."""

    end_character: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.uinteger_validator), default=None)
    ...
    collapsed_text: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class CallHierarchyItem:
    ...
    detail: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class SemanticTokens:
    ...
    result_id: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class SemanticTokensOptionsFullType1:
    delta: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class SemanticTokensOptions:
    ...
    full: Optional[Union[bool, 'SemanticTokensOptionsFullType1']] = attrs.field(default=None)
...
class SemanticTokensRegistrationOptions:
    ...
    full: Optional[Union[bool, 'SemanticTokensRegistrationOptionsFullType1']] = attrs.field(default=None)
    """Server supports providing semantic tokens for a full document."""
...
class ShowDocumentParams:
    ...
    external: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Indicates to show the resource in an external program.
    To show, for example, `https://code.visualstudio.com/`
    in the default WEB browser set `external` to `true`."""

    take_focus: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class LinkedEditingRanges:
    ...
    word_pattern: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class WorkspaceEdit:
    ...
    document_changes: Optional[List[Union['TextDocumentEdit', 'CreateFile', 'RenameFile', 'DeleteFile']]] = attrs.field(default=None)
    ...
    change_annotations: Optional[Dict[ChangeAnnotationIdentifier, 'ChangeAnnotation']] = attrs.field(default=None)
...
class InlayHint:
    ...
    *Note* that edits are expected to change the document so that the inlay
    ...
    padding_left: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    padding_right: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class InlayHintOptions:
    ...
    resolve_provider: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class DocumentDiagnosticParams:
    ...
    identifier: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    """The additional identifier  provided during registration."""

    previous_result_id: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class DocumentDiagnosticReportPartialResult:
    ...
    related_documents: Dict[str, Union['FullDocumentDiagnosticReport', 'UnchangedDocumentDiagnosticReport']] = attrs.field()
...
class DiagnosticOptions:
    ...
    inter_file_dependencies: bool = attrs.field(validator=attrs.validators.instance_of(bool))
    """Whether the language has inter file dependencies meaning that
    editing code in one file can result in a different diagnostic
    set in another file. Inter file dependencies are common for
    most programming languages and typically uncommon for linters."""

    workspace_diagnostics: bool = attrs.field(validator=attrs.validators.instance_of(bool))
...
class InlineCompletionItem:
    ...
    filter_text: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class InitializeParamsClientInfoType:
    ...
    version: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class _InitializeParams:
    ...
    locale: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class WorkspaceFoldersInitializeParams:
    ...
    workspace_folders: Optional[Union[List[WorkspaceFolder], None]] = attrs.field(default=None)
...
class DidSaveTextDocumentParams:
    ...
    text: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class SaveOptions:
    ...
    include_text: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class PublishDiagnosticsParams:
    ...
    version: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.integer_validator), default=None)
...
class CompletionItem:
    ...
    deprecated: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Indicates if this item is deprecated.
    @deprecated Use `tags` instead."""

    preselect: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    *Note* that only one completion item can be selected and that the
    ...
    sort_text: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    ...
    insert_text: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    ...
    text_edit: Optional[Union[TextEdit, 'InsertReplaceEdit']] = attrs.field(default=None)
    """An {@link TextEdit edit} which is applied to a document when selecting
    ...
    *Note 2:* If an `InsertReplaceEdit` is returned the edit's insert range
    ...
    text_edit_text: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class CompletionListItemDefaultsType:
    ...
    edit_range: Optional[Union['Range', 'CompletionListItemDefaultsTypeEditRangeType1']] = attrs.field(default=None)
...
class CompletionList:
    ...
    item_defaults: Optional['CompletionListItemDefaultsType'] = attrs.field(default=None)
...
class CompletionOptionsCompletionItemType:
    label_details_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class CompletionOptions:
    ...
    completion_item: Optional['CompletionOptionsCompletionItemType'] = attrs.field(default=None)
...
class CompletionRegistrationOptions:
    ...
    completion_item: Optional['CompletionRegistrationOptionsCompletionItemType'] = attrs.field(default=None)
    """The server supports the following `CompletionItem` specific
    capabilities.
...
class SignatureHelp:
    ...
    active_signature: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.uinteger_validator), default=None)
    ...
    active_parameter: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.uinteger_validator), default=None)
...
class BaseSymbolInformation:
    ...
    container_name: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class DocumentSymbolOptions:
    ...
    label: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class CodeAction:
    ...
    is_preferred: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class CodeActionOptions:
    ...
    code_action_kinds: Optional[List[Union[CodeActionKind, str]]] = attrs.field(default=None)
...
class DocumentLink:
    ...
    target: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    """The uri this link points to. If missing a resolve request is sent later."""

    tooltip: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class DocumentRangeFormattingOptions:
    ...
    ranges_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class DocumentOnTypeFormattingOptions:
    ...
    first_trigger_character: str = attrs.field(validator=attrs.validators.instance_of(str))
...
class RenameOptions:
    ...
    prepare_provider: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class ApplyWorkspaceEditResult:
    ...
    failure_reason: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    """An optional textual description for why the edit was not applied.
    This may be used by the server for diagnostic logging or to provide
    a suitable error for a request that triggered the edit."""

    failed_change: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.uinteger_validator), default=None)
...
class WorkDoneProgressBegin:
    ...
    cancellable: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Controls if a cancel button should show to allow the user to cancel the
    long running operation. Clients that don't support cancellation are allowed
    to ignore the setting."""

    message: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    ...
    percentage: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.uinteger_validator), default=None)
...
class WorkDoneProgressReport:
    ...
    kind: str = attrs.field(validator=attrs.validators.in_(['report']), default='report')
...
class LogTraceParams:
    ...
    verbose: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class ConfigurationItem:
    ...
    scope_uri: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    """The scope to get the configuration section for."""

    section: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class CreateFile:
    ...
    kind: str = attrs.field(validator=attrs.validators.in_(['create']), default='create')
    """A create"""
...
class RenameFile:
    ...
    kind: str = attrs.field(validator=attrs.validators.in_(['rename']), default='rename')
    """A rename"""
...
class DeleteFile:
    ...
    kind: str = attrs.field(validator=attrs.validators.in_(['delete']), default='delete')
    """A delete"""
...
class ChangeAnnotation:
    ...
    needs_confirmation: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """A flag which indicates that user confirmation is needed
    before applying the change."""

    description: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class InlineValueVariableLookup:
    ...
    case_sensitive_lookup: bool = attrs.field(validator=attrs.validators.instance_of(bool))
    """How to perform the lookup."""

    variable_name: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class InlineValueEvaluatableExpression:
    ...
    expression: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class RelatedFullDocumentDiagnosticReport:
    ...
    related_documents: Optional[Dict[str, Union[FullDocumentDiagnosticReport, 'UnchangedDocumentDiagnosticReport']]] = attrs.field(default=None)
...
class UnchangedDocumentDiagnosticReport:
    ...
    kind: str = attrs.field(validator=attrs.validators.in_(['unchanged']), default='unchanged')
...
class NotebookDocumentChangeEventCellsType:
    structure: Optional['NotebookDocumentChangeEventCellsTypeStructureType'] = attrs.field(default=None)
    ...
    text_content: Optional[List['NotebookDocumentChangeEventCellsTypeTextContentType']] = attrs.field(default=None)
...
class InlineCompletionContext:
    ...
    selected_completion_info: Optional['SelectedCompletionInfo'] = attrs.field(default=None)
...
class StringValue:
    ...
    kind: str = attrs.field(validator=attrs.validators.in_(['snippet']), default='snippet')
...
class ServerCapabilities:
    ...
    position_encoding: Optional[Union[PositionEncodingKind, str]] = attrs.field(default=None)
    ...
    text_document_sync: Optional[Union['TextDocumentSyncOptions', TextDocumentSyncKind]] = attrs.field(default=None)
    """Defines how text documents are synced. Is either a detailed structure
    defining each notification or for backwards compatibility the
    TextDocumentSyncKind number."""

    notebook_document_sync: Optional[Union['NotebookDocumentSyncOptions', 'NotebookDocumentSyncRegistrationOptions']] = attrs.field(default=None)
    ...
    declaration_provider: Optional[Union[bool, DeclarationOptions, DeclarationRegistrationOptions]] = attrs.field(default=None)
    """The server provides Goto Declaration support."""

    definition_provider: Optional[Union[bool, DefinitionOptions]] = attrs.field(default=None)
    """The server provides goto definition support."""

    type_definition_provider: Optional[Union[bool, TypeDefinitionOptions, TypeDefinitionRegistrationOptions]] = attrs.field(default=None)
    """The server provides Goto Type Definition support."""

    implementation_provider: Optional[Union[bool, ImplementationOptions, ImplementationRegistrationOptions]] = attrs.field(default=None)
    """The server provides Goto Implementation support."""

    references_provider: Optional[Union[bool, ReferenceOptions]] = attrs.field(default=None)
    """The server provides find references support."""

    document_highlight_provider: Optional[Union[bool, DocumentHighlightOptions]] = attrs.field(default=None)
    """The server provides document highlight support."""

    document_symbol_provider: Optional[Union[bool, DocumentSymbolOptions]] = attrs.field(default=None)
    """The server provides document symbol support."""

    code_action_provider: Optional[Union[bool, CodeActionOptions]] = attrs.field(default=None)
    ...
    color_provider: Optional[Union[bool, DocumentColorOptions, DocumentColorRegistrationOptions]] = attrs.field(default=None)
    """The server provides color provider support."""

    workspace_symbol_provider: Optional[Union[bool, WorkspaceSymbolOptions]] = attrs.field(default=None)
    """The server provides workspace symbol support."""

    document_formatting_provider: Optional[Union[bool, DocumentFormattingOptions]] = attrs.field(default=None)
    """The server provides document formatting."""

    document_range_formatting_provider: Optional[Union[bool, DocumentRangeFormattingOptions]] = attrs.field(default=None)
    """The server provides document range formatting."""

    document_on_type_formatting_provider: Optional[DocumentOnTypeFormattingOptions] = attrs.field(default=None)
    ...
    folding_range_provider: Optional[Union[bool, FoldingRangeOptions, FoldingRangeRegistrationOptions]] = attrs.field(default=None)
    """The server provides folding provider support."""

    selection_range_provider: Optional[Union[bool, SelectionRangeOptions, SelectionRangeRegistrationOptions]] = attrs.field(default=None)
    """The server provides selection range support."""

    execute_command_provider: Optional[ExecuteCommandOptions] = attrs.field(default=None)
    """The server provides execute command support."""

    call_hierarchy_provider: Optional[Union[bool, CallHierarchyOptions, CallHierarchyRegistrationOptions]] = attrs.field(default=None)
    """The server provides call hierarchy support.
    
    @since 3.16.0"""
    # Since: 3.16.0

    linked_editing_range_provider: Optional[Union[bool, LinkedEditingRangeOptions, LinkedEditingRangeRegistrationOptions]] = attrs.field(default=None)
    """The server provides linked editing range support.
    
    @since 3.16.0"""
    # Since: 3.16.0

    semantic_tokens_provider: Optional[Union[SemanticTokensOptions, SemanticTokensRegistrationOptions]] = attrs.field(default=None)
    """The server provides semantic tokens support.
    
    @since 3.16.0"""
    # Since: 3.16.0

    moniker_provider: Optional[Union[bool, MonikerOptions, MonikerRegistrationOptions]] = attrs.field(default=None)
    """The server provides moniker support.
    
    @since 3.16.0"""
    # Since: 3.16.0

    type_hierarchy_provider: Optional[Union[bool, TypeHierarchyOptions, TypeHierarchyRegistrationOptions]] = attrs.field(default=None)
    """The server provides type hierarchy support.
    
    @since 3.17.0"""
    # Since: 3.17.0

    inline_value_provider: Optional[Union[bool, InlineValueOptions, InlineValueRegistrationOptions]] = attrs.field(default=None)
    """The server provides inline values.
    
    @since 3.17.0"""
    # Since: 3.17.0

    inlay_hint_provider: Optional[Union[bool, InlayHintOptions, InlayHintRegistrationOptions]] = attrs.field(default=None)
    """The server provides inlay hints.
    
    @since 3.17.0"""
    # Since: 3.17.0

    diagnostic_provider: Optional[Union[DiagnosticOptions, DiagnosticRegistrationOptions]] = attrs.field(default=None)
    """The server has support for pull model diagnostics.
    
    @since 3.17.0"""
    # Since: 3.17.0

    inline_completion_provider: Optional[Union[bool, InlineCompletionOptions]] = attrs.field(default=None)
    """Inline completion options used during static registration.
...
class Diagnostic:
    ...
    source: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
    ...
    related_information: Optional[List['DiagnosticRelatedInformation']] = attrs.field(default=None)
...
class CompletionContext:
    ...
    trigger_character: Optional[str] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(str)), default=None)
...
class ReferenceContext:
    ...
    include_declaration: bool = attrs.field(validator=attrs.validators.instance_of(bool))
...
class FormattingOptions:
    ...
    trim_trailing_whitespace: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Trim trailing whitespace on a line.
    
    @since 3.15.0"""
    # Since: 3.15.0

    insert_final_newline: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Insert a newline character at the end of the file if one does not exist.
    
    @since 3.15.0"""
    # Since: 3.15.0

    trim_final_newlines: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class CreateFileOptions:
    ...
    overwrite: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Overwrite existing file. Overwrite wins over `ignoreIfExists`"""

    ignore_if_exists: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Ignore if exists."""
...
class DeleteFileOptions:
    ...
    recursive: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Delete the content recursively if a folder is denoted."""

    ignore_if_not_exists: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class ClientCapabilities:
    ...
    text_document: Optional['TextDocumentClientCapabilities'] = attrs.field(default=None)
    """Text document specific client capabilities."""

    notebook_document: Optional['NotebookDocumentClientCapabilities'] = attrs.field(default=None)
...
class TextDocumentSyncOptions:
    ...
    open_close: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    will_save: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """If present will save notifications are sent to the server. If omitted the notification should not be
    sent."""

    will_save_wait_until: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class NotebookDocumentSyncOptionsNotebookSelectorType1:
    ...
    cells: Optional[List['NotebookDocumentSyncOptionsNotebookSelectorType1CellsType']] = attrs.field(default=None)
...
class NotebookDocumentSyncOptionsNotebookSelectorType2:
    cells: List['NotebookDocumentSyncOptionsNotebookSelectorType2CellsType'] = attrs.field()
    """The cells of the matching notebook to be synced."""
...
class NotebookDocumentSyncOptions:
    ...
    notebook_selector: List[Union['NotebookDocumentSyncOptionsNotebookSelectorType1', 'NotebookDocumentSyncOptionsNotebookSelectorType2']] = attrs.field()
    """The notebooks to be synced"""

    save: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class NotebookDocumentSyncRegistrationOptionsNotebookSelectorType1:
    ...
    cells: Optional[List['NotebookDocumentSyncRegistrationOptionsNotebookSelectorType1CellsType']] = attrs.field(default=None)
    """The cells of the matching notebook to be synced."""
...
class NotebookDocumentSyncRegistrationOptionsNotebookSelectorType2:
    cells: List['NotebookDocumentSyncRegistrationOptionsNotebookSelectorType2CellsType'] = attrs.field()
    """The cells of the matching notebook to be synced."""
...
class NotebookDocumentSyncRegistrationOptions:
    ...
    notebook_selector: List[Union['NotebookDocumentSyncRegistrationOptionsNotebookSelectorType1', 'NotebookDocumentSyncRegistrationOptionsNotebookSelectorType2']] = attrs.field()
    """The notebooks to be synced"""
...
class WorkspaceFoldersServerCapabilities:
    ...
    supported: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class FileOperationPatternOptions:
    ...
    ignore_case: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class ExecutionSummary:
    ...
    success: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class WorkspaceClientCapabilities:
    ...
    apply_edit: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client supports applying batch edits
    to the workspace by supporting the request
    'workspace/applyEdit'"""

    workspace_edit: Optional['WorkspaceEditClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to `WorkspaceEdit`s."""

    did_change_configuration: Optional['DidChangeConfigurationClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `workspace/didChangeConfiguration` notification."""

    did_change_watched_files: Optional['DidChangeWatchedFilesClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `workspace/didChangeWatchedFiles` notification."""

    symbol: Optional['WorkspaceSymbolClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `workspace/symbol` request."""

    execute_command: Optional['ExecuteCommandClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `workspace/executeCommand` request."""

    workspace_folders: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client has support for workspace folders.
    
    @since 3.6.0"""
    # Since: 3.6.0

    configuration: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client supports `workspace/configuration` requests.
    
    @since 3.6.0"""
    # Since: 3.6.0

    semantic_tokens: Optional['SemanticTokensWorkspaceClientCapabilities'] = attrs.field(default=None)
    ...
    code_lens: Optional['CodeLensWorkspaceClientCapabilities'] = attrs.field(default=None)
    ...
    file_operations: Optional['FileOperationClientCapabilities'] = attrs.field(default=None)
    """The client has support for file notifications/requests for user operations on files.
    
    Since 3.16.0"""

    inline_value: Optional['InlineValueWorkspaceClientCapabilities'] = attrs.field(default=None)
    ...
    inlay_hint: Optional['InlayHintWorkspaceClientCapabilities'] = attrs.field(default=None)
    ...
    diagnostics: Optional['DiagnosticWorkspaceClientCapabilities'] = attrs.field(default=None)
    ...
    folding_range: Optional['FoldingRangeWorkspaceClientCapabilities'] = attrs.field(default=None)
...
class TextDocumentClientCapabilities:
    ...
    synchronization: Optional['TextDocumentSyncClientCapabilities'] = attrs.field(default=None)
    ...
    signature_help: Optional['SignatureHelpClientCapabilities'] = attrs.field(default=None)
    ...
    type_definition: Optional['TypeDefinitionClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/typeDefinition` request.
    
    @since 3.6.0"""
    # Since: 3.6.0

    implementation: Optional['ImplementationClientCapabilities'] = attrs.field(default=None)
    ...
    document_highlight: Optional['DocumentHighlightClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/documentHighlight` request."""

    document_symbol: Optional['DocumentSymbolClientCapabilities'] = attrs.field(default=None)
    ...
    document_link: Optional['DocumentLinkClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/documentLink` request."""

    color_provider: Optional['DocumentColorClientCapabilities'] = attrs.field(default=None)
    ...
    formatting: Optional['DocumentFormattingClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/formatting` request."""

    range_formatting: Optional['DocumentRangeFormattingClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/rangeFormatting` request."""

    on_type_formatting: Optional['DocumentOnTypeFormattingClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/onTypeFormatting` request."""

    rename: Optional['RenameClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/rename` request."""

    folding_range: Optional['FoldingRangeClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/foldingRange` request.
    
    @since 3.10.0"""
    # Since: 3.10.0

    selection_range: Optional['SelectionRangeClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/selectionRange` request.
    
    @since 3.15.0"""
    # Since: 3.15.0

    publish_diagnostics: Optional['PublishDiagnosticsClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the `textDocument/publishDiagnostics` notification."""

    call_hierarchy: Optional['CallHierarchyClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the various call hierarchy requests.
    
    @since 3.16.0"""
    # Since: 3.16.0

    semantic_tokens: Optional['SemanticTokensClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the various semantic token request.
    
    @since 3.16.0"""
    # Since: 3.16.0

    linked_editing_range: Optional['LinkedEditingRangeClientCapabilities'] = attrs.field(default=None)
    ...
    type_hierarchy: Optional['TypeHierarchyClientCapabilities'] = attrs.field(default=None)
    ...
    inline_completion: Optional['InlineCompletionClientCapabilities'] = attrs.field(default=None)
...
class WindowClientCapabilities:
    ...
    show_message: Optional['ShowMessageRequestClientCapabilities'] = attrs.field(default=None)
    """Capabilities specific to the showMessage request.
    
    @since 3.16.0"""
    # Since: 3.16.0

    show_document: Optional['ShowDocumentClientCapabilities'] = attrs.field(default=None)
...
class GeneralClientCapabilities:
    ...
    stale_request_support: Optional['GeneralClientCapabilitiesStaleRequestSupportType'] = attrs.field(default=None)
    ...
    regular_expressions: Optional['RegularExpressionsClientCapabilities'] = attrs.field(default=None)
    ...
    position_encodings: Optional[List[Union[PositionEncodingKind, str]]] = attrs.field(default=None)
...
class WorkspaceEditClientCapabilitiesChangeAnnotationSupportType:
    groups_on_label: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class WorkspaceEditClientCapabilities:
    ...
    document_changes: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client supports versioned document changes in `WorkspaceEdit`s"""

    resource_operations: Optional[List[ResourceOperationKind]] = attrs.field(default=None)
    ...
    normalizes_line_endings: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    change_annotation_support: Optional['WorkspaceEditClientCapabilitiesChangeAnnotationSupportType'] = attrs.field(default=None)
...
class DidChangeConfigurationClientCapabilities:
    ...
    dynamic_registration: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class DidChangeWatchedFilesClientCapabilities:
    ...
    relative_pattern_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class WorkspaceSymbolClientCapabilities:
    ...
    symbol_kind: Optional['WorkspaceSymbolClientCapabilitiesSymbolKindType'] = attrs.field(default=None)
    """Specific capabilities for the `SymbolKind` in the `workspace/symbol` request."""

    tag_support: Optional['WorkspaceSymbolClientCapabilitiesTagSupportType'] = attrs.field(default=None)
    ...
    resolve_support: Optional['WorkspaceSymbolClientCapabilitiesResolveSupportType'] = attrs.field(default=None)
...
class SemanticTokensWorkspaceClientCapabilities:
    ...
    refresh_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class FileOperationClientCapabilities:
    ...
    did_create: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client has support for sending didCreateFiles notifications."""

    will_create: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client has support for sending willCreateFiles requests."""

    did_rename: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client has support for sending didRenameFiles notifications."""

    will_rename: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client has support for sending willRenameFiles requests."""

    did_delete: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client has support for sending didDeleteFiles notifications."""

    will_delete: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class TextDocumentSyncClientCapabilities:
    ...
    did_save: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class CompletionClientCapabilitiesCompletionItemType:
    snippet_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    commit_characters_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    deprecated_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Client supports the deprecated property on a completion item."""

    preselect_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Client supports the preselect property on a completion item."""

    tag_support: Optional['CompletionClientCapabilitiesCompletionItemTypeTagSupportType'] = attrs.field(default=None)
    ...
    insert_replace_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    resolve_support: Optional['CompletionClientCapabilitiesCompletionItemTypeResolveSupportType'] = attrs.field(default=None)
    ...
    insert_text_mode_support: Optional['CompletionClientCapabilitiesCompletionItemTypeInsertTextModeSupportType'] = attrs.field(default=None)
...
class CompletionClientCapabilities:
    ...
    completion_item: Optional['CompletionClientCapabilitiesCompletionItemType'] = attrs.field(default=None)
    """The client supports the following `CompletionItem` specific
    capabilities."""

    completion_item_kind: Optional['CompletionClientCapabilitiesCompletionItemKindType'] = attrs.field(default=None)
    ...
    context_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client supports to send additional context information for a
    `textDocument/completion` request."""

    completion_list: Optional['CompletionClientCapabilitiesCompletionListType'] = attrs.field(default=None)
...
class SignatureHelpClientCapabilitiesSignatureInformationTypeParameterInformationType:
    label_offset_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class SignatureHelpClientCapabilitiesSignatureInformationType:
    ...
    parameter_information: Optional['SignatureHelpClientCapabilitiesSignatureInformationTypeParameterInformationType'] = attrs.field(default=None)
    """Client capabilities specific to parameter information."""

    active_parameter_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class SignatureHelpClientCapabilities:
    ...
    signature_information: Optional['SignatureHelpClientCapabilitiesSignatureInformationType'] = attrs.field(default=None)
...
class DeclarationClientCapabilities:
    ...
    link_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class DocumentSymbolClientCapabilities:
    ...
    symbol_kind: Optional['DocumentSymbolClientCapabilitiesSymbolKindType'] = attrs.field(default=None)
    """Specific capabilities for the `SymbolKind` in the
    `textDocument/documentSymbol` request."""

    hierarchical_document_symbol_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """The client supports hierarchical document symbols."""

    tag_support: Optional['DocumentSymbolClientCapabilitiesTagSupportType'] = attrs.field(default=None)
    ...
    label_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class CodeActionClientCapabilities:
    ...
    code_action_literal_support: Optional['CodeActionClientCapabilitiesCodeActionLiteralSupportType'] = attrs.field(default=None)
    ...
    is_preferred_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Whether code action supports the `isPreferred` property.
    
    @since 3.15.0"""
    # Since: 3.15.0

    disabled_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Whether code action supports the `disabled` property.
    
    @since 3.16.0"""
    # Since: 3.16.0

    data_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    resolve_support: Optional['CodeActionClientCapabilitiesResolveSupportType'] = attrs.field(default=None)
    ...
    honors_change_annotations: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class DocumentLinkClientCapabilities:
    ...
    tooltip_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class RenameClientCapabilities:
    ...
    prepare_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    prepare_support_default_behavior: Optional[PrepareSupportDefaultBehavior] = attrs.field(default=None)
...
class FoldingRangeClientCapabilitiesFoldingRangeType:
    collapsed_text: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class FoldingRangeClientCapabilities:
    ...
    range_limit: Optional[int] = attrs.field(validator=attrs.validators.optional(validators.uinteger_validator), default=None)
    """The maximum number of folding ranges that the client prefers to receive
    per document. The value serves as a hint, servers are free to follow the
    limit."""

    line_folding_only: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """If set, the client signals that it only supports folding complete lines.
    If set, client will ignore specified `startCharacter` and `endCharacter`
    properties in a FoldingRange."""

    folding_range_kind: Optional['FoldingRangeClientCapabilitiesFoldingRangeKindType'] = attrs.field(default=None)
    """Specific options for the folding range kind.
    
    @since 3.17.0"""
    # Since: 3.17.0

    folding_range: Optional['FoldingRangeClientCapabilitiesFoldingRangeType'] = attrs.field(default=None)
...
class PublishDiagnosticsClientCapabilities:
    ...
    related_information: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Whether the clients accepts diagnostics with related information."""

    tag_support: Optional['PublishDiagnosticsClientCapabilitiesTagSupportType'] = attrs.field(default=None)
    ...
    version_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    code_description_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class SemanticTokensClientCapabilitiesRequestsType:
    ...
    full: Optional[Union[bool, 'SemanticTokensClientCapabilitiesRequestsTypeFullType1']] = attrs.field(default=None)
...
class SemanticTokensClientCapabilities:
    ...
    overlapping_token_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Whether the client supports tokens that can overlap each other."""

    multiline_token_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    """Whether the client supports tokens that can span multiple lines."""

    server_cancel_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
    ...
    augments_syntax_tokens: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class InlayHintClientCapabilities:
    ...
    resolve_support: Optional['InlayHintClientCapabilitiesResolveSupportType'] = attrs.field(default=None)
...
class DiagnosticClientCapabilities:
    ...
    related_document_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class NotebookDocumentSyncClientCapabilities:
    ...
    execution_summary_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class ShowMessageRequestClientCapabilitiesMessageActionItemType:
    additional_properties_support: Optional[bool] = attrs.field(validator=attrs.validators.optional(attrs.validators.instance_of(bool)), default=None)
...
class ShowMessageRequestClientCapabilities:
    ...
    message_action_item: Optional['ShowMessageRequestClientCapabilitiesMessageActionItemType'] = attrs.field(default=None)
...
class TextDocumentInlineCompletionResponse:
    id: Optional[Union[int, str]] = attrs.field()
    """The request id."""
    result: Union[InlineCompletionList, List[InlineCompletionItem], None] = attrs.field(default=None)
    jsonrpc: str = attrs.field(default="2.0")
...
class TextDocumentCompletionResponse:
    id: Optional[Union[int, str]] = attrs.field()
    """The request id."""
    result: Union[List[CompletionItem], CompletionList, None] = attrs.field(default=None)
    jsonrpc: str = attrs.field(default="2.0")
...
class TextDocumentDocumentSymbolResponse:
    id: Optional[Union[int, str]] = attrs.field()
    """The request id."""
    result: Union[List[SymbolInformation], List[DocumentSymbol], None] = attrs.field(default=None)
    jsonrpc: str = attrs.field(default="2.0")
...
class WorkspaceSymbolResponse:
    id: Optional[Union[int, str]] = attrs.field()
    """The request id."""
    result: Union[List[SymbolInformation], List[WorkspaceSymbol], None] = attrs.field(default=None)
    jsonrpc: str = attrs.field(default="2.0")
...
METHOD_TO_TYPES = {
    # Requests
    CALL_HIERARCHY_INCOMING_CALLS: (CallHierarchyIncomingCallsRequest, CallHierarchyIncomingCallsResponse, CallHierarchyIncomingCallsParams, None),
    CALL_HIERARCHY_OUTGOING_CALLS: (CallHierarchyOutgoingCallsRequest, CallHierarchyOutgoingCallsResponse, CallHierarchyOutgoingCallsParams, None),
    CLIENT_REGISTER_CAPABILITY: (ClientRegisterCapabilityRequest, ClientRegisterCapabilityResponse, RegistrationParams, None),
    CLIENT_UNREGISTER_CAPABILITY: (ClientUnregisterCapabilityRequest, ClientUnregisterCapabilityResponse, UnregistrationParams, None),
    CODE_ACTION_RESOLVE: (CodeActionResolveRequest, CodeActionResolveResponse, CodeAction, None),
    CODE_LENS_RESOLVE: (CodeLensResolveRequest, CodeLensResolveResponse, CodeLens, None),
    COMPLETION_ITEM_RESOLVE: (CompletionItemResolveRequest, CompletionItemResolveResponse, CompletionItem, None),
    DOCUMENT_LINK_RESOLVE: (DocumentLinkResolveRequest, DocumentLinkResolveResponse, DocumentLink, None),
    INITIALIZE: (InitializeRequest, InitializeResponse, InitializeParams, None),
    INLAY_HINT_RESOLVE: (InlayHintResolveRequest, InlayHintResolveResponse, InlayHint, None),
    SHUTDOWN: (ShutdownRequest, ShutdownResponse, None, None),
    TEXT_DOCUMENT_CODE_ACTION: (TextDocumentCodeActionRequest, TextDocumentCodeActionResponse, CodeActionParams, CodeActionRegistrationOptions),
    TEXT_DOCUMENT_CODE_LENS: (TextDocumentCodeLensRequest, TextDocumentCodeLensResponse, CodeLensParams, CodeLensRegistrationOptions),
    TEXT_DOCUMENT_COLOR_PRESENTATION: (TextDocumentColorPresentationRequest, TextDocumentColorPresentationResponse, ColorPresentationParams, TextDocumentColorPresentationOptions),
    TEXT_DOCUMENT_COMPLETION: (TextDocumentCompletionRequest, TextDocumentCompletionResponse, CompletionParams, CompletionRegistrationOptions),
    TEXT_DOCUMENT_DECLARATION: (TextDocumentDeclarationRequest, TextDocumentDeclarationResponse, DeclarationParams, DeclarationRegistrationOptions),
    ...
    TEXT_DOCUMENT_DIAGNOSTIC: (TextDocumentDiagnosticRequest, TextDocumentDiagnosticResponse, DocumentDiagnosticParams, DiagnosticRegistrationOptions),
    TEXT_DOCUMENT_DOCUMENT_COLOR: (TextDocumentDocumentColorRequest, TextDocumentDocumentColorResponse, DocumentColorParams, DocumentColorRegistrationOptions),
    TEXT_DOCUMENT_DOCUMENT_HIGHLIGHT: (TextDocumentDocumentHighlightRequest, TextDocumentDocumentHighlightResponse, DocumentHighlightParams, DocumentHighlightRegistrationOptions),
    TEXT_DOCUMENT_DOCUMENT_LINK: (TextDocumentDocumentLinkRequest, TextDocumentDocumentLinkResponse, DocumentLinkParams, DocumentLinkRegistrationOptions),
    TEXT_DOCUMENT_DOCUMENT_SYMBOL: (TextDocumentDocumentSymbolRequest, TextDocumentDocumentSymbolResponse, DocumentSymbolParams, DocumentSymbolRegistrationOptions),
    TEXT_DOCUMENT_FOLDING_RANGE: (TextDocumentFoldingRangeRequest, TextDocumentFoldingRangeResponse, FoldingRangeParams, FoldingRangeRegistrationOptions),
    TEXT_DOCUMENT_FORMATTING: (TextDocumentFormattingRequest, TextDocumentFormattingResponse, DocumentFormattingParams, DocumentFormattingRegistrationOptions),
    TEXT_DOCUMENT_HOVER: (TextDocumentHoverRequest, TextDocumentHoverResponse, HoverParams, HoverRegistrationOptions),
    TEXT_DOCUMENT_IMPLEMENTATION: (TextDocumentImplementationRequest, TextDocumentImplementationResponse, ImplementationParams, ImplementationRegistrationOptions),
    TEXT_DOCUMENT_INLAY_HINT: (TextDocumentInlayHintRequest, TextDocumentInlayHintResponse, InlayHintParams, InlayHintRegistrationOptions),
    TEXT_DOCUMENT_INLINE_COMPLETION: (TextDocumentInlineCompletionRequest, TextDocumentInlineCompletionResponse, InlineCompletionParams, InlineCompletionRegistrationOptions),
    TEXT_DOCUMENT_INLINE_VALUE: (TextDocumentInlineValueRequest, TextDocumentInlineValueResponse, InlineValueParams, InlineValueRegistrationOptions),
    TEXT_DOCUMENT_LINKED_EDITING_RANGE: (TextDocumentLinkedEditingRangeRequest, TextDocumentLinkedEditingRangeResponse, LinkedEditingRangeParams, LinkedEditingRangeRegistrationOptions),
    TEXT_DOCUMENT_MONIKER: (TextDocumentMonikerRequest, TextDocumentMonikerResponse, MonikerParams, MonikerRegistrationOptions),
    TEXT_DOCUMENT_ON_TYPE_FORMATTING: (TextDocumentOnTypeFormattingRequest, TextDocumentOnTypeFormattingResponse, DocumentOnTypeFormattingParams, DocumentOnTypeFormattingRegistrationOptions),
    TEXT_DOCUMENT_PREPARE_CALL_HIERARCHY: (TextDocumentPrepareCallHierarchyRequest, TextDocumentPrepareCallHierarchyResponse, CallHierarchyPrepareParams, CallHierarchyRegistrationOptions),
    TEXT_DOCUMENT_PREPARE_RENAME: (TextDocumentPrepareRenameRequest, TextDocumentPrepareRenameResponse, PrepareRenameParams, None),
    TEXT_DOCUMENT_PREPARE_TYPE_HIERARCHY: (TextDocumentPrepareTypeHierarchyRequest, TextDocumentPrepareTypeHierarchyResponse, TypeHierarchyPrepareParams, TypeHierarchyRegistrationOptions),
    TEXT_DOCUMENT_RANGES_FORMATTING: (TextDocumentRangesFormattingRequest, TextDocumentRangesFormattingResponse, DocumentRangesFormattingParams, DocumentRangeFormattingRegistrationOptions),
    ...
    TEXT_DOCUMENT_REFERENCES: (TextDocumentReferencesRequest, TextDocumentReferencesResponse, ReferenceParams, ReferenceRegistrationOptions),
    TEXT_DOCUMENT_RENAME: (TextDocumentRenameRequest, TextDocumentRenameResponse, RenameParams, RenameRegistrationOptions),
    TEXT_DOCUMENT_SELECTION_RANGE: (TextDocumentSelectionRangeRequest, TextDocumentSelectionRangeResponse, SelectionRangeParams, SelectionRangeRegistrationOptions),
    TEXT_DOCUMENT_SEMANTIC_TOKENS_FULL: (TextDocumentSemanticTokensFullRequest, TextDocumentSemanticTokensFullResponse, SemanticTokensParams, SemanticTokensRegistrationOptions),
    TEXT_DOCUMENT_SEMANTIC_TOKENS_FULL_DELTA: (TextDocumentSemanticTokensFullDeltaRequest, TextDocumentSemanticTokensFullDeltaResponse, SemanticTokensDeltaParams, SemanticTokensRegistrationOptions),
    ...
    TEXT_DOCUMENT_SIGNATURE_HELP: (TextDocumentSignatureHelpRequest, TextDocumentSignatureHelpResponse, SignatureHelpParams, SignatureHelpRegistrationOptions),
    TEXT_DOCUMENT_TYPE_DEFINITION: (TextDocumentTypeDefinitionRequest, TextDocumentTypeDefinitionResponse, TypeDefinitionParams, TypeDefinitionRegistrationOptions),
    TEXT_DOCUMENT_WILL_SAVE_WAIT_UNTIL: (TextDocumentWillSaveWaitUntilRequest, TextDocumentWillSaveWaitUntilResponse, WillSaveTextDocumentParams, TextDocumentRegistrationOptions),
    TYPE_HIERARCHY_SUBTYPES: (TypeHierarchySubtypesRequest, TypeHierarchySubtypesResponse, TypeHierarchySubtypesParams, None),
    TYPE_HIERARCHY_SUPERTYPES: (TypeHierarchySupertypesRequest, TypeHierarchySupertypesResponse, TypeHierarchySupertypesParams, None),
    WINDOW_SHOW_DOCUMENT: (WindowShowDocumentRequest, WindowShowDocumentResponse, ShowDocumentParams, None),
    WINDOW_SHOW_MESSAGE_REQUEST: (WindowShowMessageRequestRequest, WindowShowMessageRequestResponse, ShowMessageRequestParams, None),
    WINDOW_WORK_DONE_PROGRESS_CREATE: (WindowWorkDoneProgressCreateRequest, WindowWorkDoneProgressCreateResponse, WorkDoneProgressCreateParams, None),
    WORKSPACE_APPLY_EDIT: (WorkspaceApplyEditRequest, WorkspaceApplyEditResponse, ApplyWorkspaceEditParams, None),
    WORKSPACE_CODE_LENS_REFRESH: (WorkspaceCodeLensRefreshRequest, WorkspaceCodeLensRefreshResponse, None, None),
    WORKSPACE_CONFIGURATION: (WorkspaceConfigurationRequest, WorkspaceConfigurationResponse, ConfigurationParams, None),
    WORKSPACE_DIAGNOSTIC: (WorkspaceDiagnosticRequest, WorkspaceDiagnosticResponse, WorkspaceDiagnosticParams, None),
    WORKSPACE_DIAGNOSTIC_REFRESH: (WorkspaceDiagnosticRefreshRequest, WorkspaceDiagnosticRefreshResponse, None, None),
    WORKSPACE_EXECUTE_COMMAND: (WorkspaceExecuteCommandRequest, WorkspaceExecuteCommandResponse, ExecuteCommandParams, ExecuteCommandRegistrationOptions),
    WORKSPACE_FOLDING_RANGE_REFRESH: (WorkspaceFoldingRangeRefreshRequest, WorkspaceFoldingRangeRefreshResponse, None, None),
    WORKSPACE_INLAY_HINT_REFRESH: (WorkspaceInlayHintRefreshRequest, WorkspaceInlayHintRefreshResponse, None, None),
    WORKSPACE_INLINE_VALUE_REFRESH: (WorkspaceInlineValueRefreshRequest, WorkspaceInlineValueRefreshResponse, None, None),
    WORKSPACE_SEMANTIC_TOKENS_REFRESH: (WorkspaceSemanticTokensRefreshRequest, WorkspaceSemanticTokensRefreshResponse, None, None),
    WORKSPACE_SYMBOL: (WorkspaceSymbolRequest, WorkspaceSymbolResponse, WorkspaceSymbolParams, WorkspaceSymbolRegistrationOptions),
    WORKSPACE_SYMBOL_RESOLVE: (WorkspaceSymbolResolveRequest, WorkspaceSymbolResolveResponse, WorkspaceSymbol, None),
    WORKSPACE_WILL_CREATE_FILES: (WorkspaceWillCreateFilesRequest, WorkspaceWillCreateFilesResponse, CreateFilesParams, FileOperationRegistrationOptions),
    ...
    WORKSPACE_WILL_RENAME_FILES: (WorkspaceWillRenameFilesRequest, WorkspaceWillRenameFilesResponse, RenameFilesParams, FileOperationRegistrationOptions),
    WORKSPACE_WORKSPACE_FOLDERS: (WorkspaceWorkspaceFoldersRequest, WorkspaceWorkspaceFoldersResponse, None, None),
    # Notifications
    ...
    NOTEBOOK_DOCUMENT_DID_CHANGE: (NotebookDocumentDidChangeNotification, None, DidChangeNotebookDocumentParams, None),
    NOTEBOOK_DOCUMENT_DID_CLOSE: (NotebookDocumentDidCloseNotification, None, DidCloseNotebookDocumentParams, None),
    NOTEBOOK_DOCUMENT_DID_OPEN: (NotebookDocumentDidOpenNotification, None, DidOpenNotebookDocumentParams, None),
    NOTEBOOK_DOCUMENT_DID_SAVE: (NotebookDocumentDidSaveNotification, None, DidSaveNotebookDocumentParams, None),
    ...
    TEXT_DOCUMENT_DID_CHANGE: (TextDocumentDidChangeNotification, None, DidChangeTextDocumentParams, TextDocumentChangeRegistrationOptions),
    TEXT_DOCUMENT_DID_CLOSE: (TextDocumentDidCloseNotification, None, DidCloseTextDocumentParams, TextDocumentRegistrationOptions),
    TEXT_DOCUMENT_DID_OPEN: (TextDocumentDidOpenNotification, None, DidOpenTextDocumentParams, TextDocumentRegistrationOptions),
    TEXT_DOCUMENT_DID_SAVE: (TextDocumentDidSaveNotification, None, DidSaveTextDocumentParams, TextDocumentSaveRegistrationOptions),
    TEXT_DOCUMENT_PUBLISH_DIAGNOSTICS: (TextDocumentPublishDiagnosticsNotification, None, PublishDiagnosticsParams, None),
    TEXT_DOCUMENT_WILL_SAVE: (TextDocumentWillSaveNotification, None, WillSaveTextDocumentParams, TextDocumentRegistrationOptions),
