---
name: Bug Report
about: Create an issue for a bug in the autopep8 tools extension for VS Code.
title: ''
labels: 'bug'
assignees: ''
...
4. Select `autopep8` from the dropdown.
...
Steps:
1. Use the steps at the top of this page `Steps to set log level to trace and view` to get to the `autopep8` logs.
